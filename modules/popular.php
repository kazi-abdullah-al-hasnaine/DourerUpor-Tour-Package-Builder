...
<section id="popular-section">
        ...
        ?>
            <div class="package-card" data-package-id="<?php echo $package_id; ?>">
                <div class="left">
                    <div class="package-cover lazy-bg" data-bg="<?php echo getLazyBackgroundImage("img/package-cover/{$coverImage}"); ?>" style="width: 250px; height: 250px; background-repeat: no-repeat; background-size: cover; border-radius: 10px;"></div>
